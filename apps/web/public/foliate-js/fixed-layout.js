// bookdock: public vendored modules are loaded directly by the browser; the
// runtime already provides CSSStyleSheet in supported reader environments.
...
// the same pressure the PDF range-read throttle guards against.
...
// so both margins are auto to centre it. Both inline margins are
    ...
    async #loadScrollPage(pageData) {
        ...
        try {
            ...
            if (doc) {
                ...
                // an instant lurch. Just drop pointer-events so
