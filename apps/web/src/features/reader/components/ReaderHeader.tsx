...
export function ReaderHeader({ title, visible, className, estimatedMinutes, settingsOpen, onAddBookmark, onToggleSettings, onToggleFullscreen, bookmarkActive }: ReaderHeaderProps) {
  return (
    <header
      className={cn(
