...
export default function HistoryCapsule({ canBack, canForward, onBack, onForward }: HistoryCapsuleProps) {
  ...
  return (
    <div className="pointer-events-auto absolute bottom-3 left-3 sm:left-4 z-[60] flex h-11 items-center gap-0.5 rounded-full border border-[var(--bd-read-accent)] bg-[var(--bd-read-bg)] px-1.5 shadow-xl">
      {canBack && (
