...
export default function AiPromptRow({ prompt, disabled, onToggle, onEdit, onDelete }: AiPromptRowProps) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className={cn('truncate text-xs', !prompt.enabled && 'text-stone-400 line-through dark:text-stone-500')}>
          {prompt.name}
        </p>
      ...
      <span className="hidden shrink-0 rounded border border-stone-200 px-1.5 py-0.5 text-[10px] text-stone-400 sm:inline dark:border-stone-700">
