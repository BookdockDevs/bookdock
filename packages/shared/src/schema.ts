...
export const settingsUpdateSchema = z.object({
  ...
  library: z.object({
    ...
    shelfSort: z.object({
      mode: z.enum(LIBRARY_SORT_MODES),
    ...
    bookSort: z.object({
      field: z.enum(BOOK_SORT_PREF_FIELDS),
      dir: z.enum(['asc', 'desc']).optional(),
    }).optional(),
...
export const bookMetadataSchema = z.object({
  ...
  modified: z.string().max(50).optional(),
  isbn: z.string().max(20).optional(),
  identifier: z.string().max(100).optional(),
  language: z.string().max(20).optional(),
  languages: z.array(z.string().max(20)).max(20).optional(),
  subtitle: z.string().max(500).optional(),
  sortAs: z.string().max(500).optional(),
  authorSortAs: z.string().max(500).optional(),
